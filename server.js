...
// Embedded directly so Railway deployment never needs the CSV file present.
...
let VIRAL_HOOKS = VIRAL_HOOKS_DATA; // always loaded, no file I/O needed

function loadViralHooks() {
  // Hooks are embedded — nothing to load. Just log confirmation.
...
2. script — what Ian says. Read the WRONG/RIGHT voice examples in your instructions and write RIGHT. 4-8 sentences. Moves forward, no wrap-up.
